...
labelBalance.addEventListener('click', function (e) {
  [...document.querySelectorAll('.movements__row')].forEach((row, i) => {
    ...
    if (i % 3 === 0) row.style.backgroundColor = '#466';
  });
}); */
...
console.log(new Date('Feb 18 2022 09:59:25'));
console.log(new Date('Dec 24, 2015'));
console.log(new Date(account1.movementsDates[0]));

console.log(new Date(2037, 10, 19, 15, 23, 5));
console.log(new Date(2037, 10, 33)); // corrects to next day
...
setInterval(() => {
   const now = new Date();
   console.log(`Clock => ${now.getHours()}:${now.getMinutes()}:${now.getSeconds()}`);
}, 1000);
